...
//
const debug = require('debug')('oa:test:unit:agent:graylog');
...
// Test setup
const { AgentGraylog } = require('../../lib/agent_graylog');
...
describe('AgentGraylog', function () {
  it('loads rules into AgentGraylog', function () {
    const the_graylog = new AgentGraylog({
  ...
  describe('Loaded', function () {
    ...
    it('maps a sev', function () {
      const ev = the_graylog.run(syslog_ev);
  ...
  describe('Generates', function () {
    ...
    it('can run', function () {
      ...
      const new_ev = the_graylog.run(ev);
